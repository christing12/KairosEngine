...
struct ICVarSystemConfig : ISystemConfig {
...
class ICVarSystem : public ISystem {
public:
	KRS_INTERFACE_NON_COPYABLE(ICVarSystem);

	virtual CVarParameter* GetCVar(StringUtils::StringHash hash) = 0;
	virtual double* GetFloatCVar(StringUtils::StringHash has) = 0;
