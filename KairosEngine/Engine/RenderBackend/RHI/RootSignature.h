...
public:
	...
	std::optional<ParameterIndex> GetParameterIndex(const RootParameter::RootSigLoc location) const;

	inline Uint32 NumParameters() const { return m_DescriptorTables.size() + m_Descriptors.size() + m_Constants.size(); }
