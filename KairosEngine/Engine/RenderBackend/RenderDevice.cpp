...
namespace Kairos {
	...
	{
		m_GraphicsQueue		= CommandQueue(this, D3D12_COMMAND_LIST_TYPE_DIRECT, L"Graphics Queue");
		m_ComputeQueue		= CommandQueue(this, D3D12_COMMAND_LIST_TYPE_COMPUTE, L"Compute Queue");
		m_CopyQueue			= CommandQueue(this, D3D12_COMMAND_LIST_TYPE_COPY, L"Copy Queue");
	}
	...
	void RenderDevice::BindBuffer(RenderHandle handle, GraphicsContext& context)
	{
